# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-12-07 04:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Campuses', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='main.ClassList', verbose_name='已报班级')),
            ],
            options={
                'verbose_name': '客户信息表',
        ...
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.Userinfo', verbose_name='销售'),
        ),
        migrations.AddField(
            model_name='customer',
            name='introduce_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.Customer', verbose_name='转介绍自学员'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='main.Userinfo', verbose_name='老师'),
        ),
